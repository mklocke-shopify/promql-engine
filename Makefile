...
internal/prometheus: $(GOIMPORTS) ## Ensure latest prometheus parser package is synced.
	rm -rf internal/prometheus
	rm -rf tmp/prometheus
	git clone --depth 1 --branch v0.42.0 https://github.com/prometheus/prometheus/ tmp/prometheus
